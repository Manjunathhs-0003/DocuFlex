...
def check_expiring_documents():
    ...
    with app.app_context():
        ...
        expiring_documents = Document.query.filter(Document.end_date <= threshold_date).all()
...
scheduler.add_job(func=check_expiring_documents, trigger="interval", days=1)  # Run daily
scheduler.start()
